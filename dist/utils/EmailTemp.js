...
exports.emailTemplates = {
    interviewInvite: (candidateName, jobTitle, interviewDate, interviewTime, meetingUrl, companyName) => `
...
`,
    interviewScheduled: (candidateName, jobTitle, companyName, interviewDate, interviewTime) => `
    <div style="font-family: 'Inter', sans-serif; padding: 24px; max-width: 600px; margin: auto; border: 1px solid #E5E7EB; border-radius: 12px; background: #000; color: #FFFFFF;">
